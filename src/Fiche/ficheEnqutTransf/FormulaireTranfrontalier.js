...
// Fonction pour afficher le dropdown de sélection de la région
const renderRegion = () => (
            <Dropdown
                style={styles.dropdown}
                data={regions.filter((region) =>
                    region.nom_region.toLowerCase().includes(searchRegion.toLowerCase())
                )}
                search
                ...
                onChange={(item) => {
                    setSelectedRegion(item.code_region);
                }}
    ...
    */
    ...
    const postForm = async () => {
      ...
      try {
        ...
        await ConsommationServices.createJournalier(ficheData);
