    ...
    const syncDataWithServer = async () => {
        ...
        for (let i = 0; i < totalFiches; i++) {
            ...
            try {
                ...
                const dataToSend = {
                    date_enquete: fiche._raw.date_enquete || '2024-09-30', // Assurez-vous que ce champ a une valeur
                    collecteur: fiche._raw.collecteur || 0, // Valeur par défaut si elle est manquante
                    volume_poissons_peches: fiche._raw.volume_poissons_peches || 0,
                    prix_moyen_semaine_grossiste: fiche._raw.prix_moyen_semaine_grossiste || 0,
                    prix_moyen_semaine_detaillant: fiche._raw.prix_moyen_semaine_detaillant || 0,
                    niveau_disponibilite: fiche._raw.niveau_disponibilite || 'Inconnu', // Valeur par défaut
                    observation: fiche._raw.observation || 'Aucune', // Valeur par défaut
                    enquete: fiche._raw.enquete || 0, // Assurez-vous que ce champ est bien fourni
                    principale_espece_peche: fiche._raw.principale_espece_peche || 'Inconnue', // Valeur par défaut
                };
